...
class Group19State extends State<Group19> {
  ...
  bool _isPasswordVisible = false; // Define password visibility state
  ...
  Widget _buildInputField(
      ...
      {bool obscureText = false, IconButton? icon}) {
    return SizedBox(
      width: 400,
      height: 65,
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: icon,  // Set the icon to the right side of the input box
        ),
        validator: validator,
      ),
    );
